...
if max_delay>0
   [STraj,T] = add_delay_to_signal(max_delay,signal);
    ...
    STraj(:,1)=(signal.Data1)';
    STraj(:,2)=(signal.Data2)';
    T=signal.Time';
end
...
para.upper_const_dev=[0 0];             %Vector for upper bound deviation
para.lower_const_dev=[0 0];             %Vector for lower bound deviation
