...
max_delay=0;
if max_delay>0
   [STraj,T] = add_delay_to_signal(max_delay,VehicleSpeed);
else
    STraj=VehicleSpeed.Data;
    T=VehicleSpeed.Time;
end
...
para.upper_const_dev=5;             %Vector for upper bound deviation
para.lower_const_dev=5;             %Vector for lower bound deviation
